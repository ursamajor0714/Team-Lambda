...
import adLeft from '../assets/paris.png'
import adrigth from '../assets/tous.png'
  ...
  return (
    <div style={{ display: 'flex', gap: 16, padding: 15 }}>
      ...
      <div style={{ width: 210, flexShrink: 0 }}>
        <a href="https://www.paris.co.kr/" target="_blank" rel="noreferrer">
          <img src={adLeft} alt="파리바게트광고" width="210" height="600"
            style={{ border: '1px solid #eee', borderRadius: 6, display: 'block', background: '#f5f5f5' }} />
        </a>
      </div>
    ...
    {p.user}
      ...
      <div style={{ width: 230, flexShrink: 0 }}>
        <a href="https://www.tlj.co.kr/index.asp" target="_blank" rel="noreferrer">
          <img src={adrigth} alt="광고" width="230" height="600"
            style={{ border: '1px solid #eee', borderRadius: 6, display: 'block', background: '#f5f5f5' }} />
        </a>
      </div>
